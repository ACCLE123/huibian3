...
B221:                               	; preds = %B224
  ...
  %t237 = load i32, i32* %t126, align 4
  %t127 = call i32 @func1(i32 %t124, i32 %t236, i32 %t237)
  %t128 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 2
  %t238 = load i32, i32* %t128, align 4
  %t129 = call i32 @func2(i32 %t127, i32 %t238)
  %t130 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 3
  %t239 = load i32, i32* %t130, align 4
  %t131 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 4
  %t240 = load i32, i32* %t131, align 4
  %t132 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 5
  %t241 = load i32, i32* %t132, align 4
  %t133 = call i32 @func5(i32 %t241)
  %t134 = call i32 @func3(i32 %t240, i32 %t133)
  %t135 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 6
  %t242 = load i32, i32* %t135, align 4
  %t136 = call i32 @func5(i32 %t242)
  %t137 = call i32 @func2(i32 %t134, i32 %t136)
  %t138 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 7
  %t243 = load i32, i32* %t138, align 4
  %t139 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 8
  %t244 = load i32, i32* %t139, align 4
  %t140 = call i32 @func7(i32 %t244)
  %t141 = call i32 @func1(i32 %t137, i32 %t243, i32 %t140)
  %t142 = getelementptr inbounds [10 x i32], [10 x i32]* %t217, i32 0, i32 9
  %t245 = load i32, i32* %t142, align 4
  %t143 = call i32 @func5(i32 %t245)
  %t144 = call i32 @func2(i32 %t141, i32 %t143)
  %t145 = load i32, i32* %t213, align 4
  %t146 = call i32 @func3(i32 %t144, i32 %t145)
  %t147 = call i32 @func1(i32 %t129, i32 %t239, i32 %t146)
  store i32 %t147, i32* %t225, align 4
  %t149 = load i32, i32* %t225, align 4
  ret i32 %t149
}
declare i32 @getint()
