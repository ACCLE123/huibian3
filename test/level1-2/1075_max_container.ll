...
define i32 @main() {
B113:
  %t115 = alloca [10 x i32], align 4
  %t114 = alloca i32, align 4
  %t55 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 0
  store i32 3, i32* %t55, align 4
  %t56 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 1
  store i32 3, i32* %t56, align 4
  %t57 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 2
  store i32 9, i32* %t57, align 4
  %t58 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 3
  store i32 0, i32* %t58, align 4
  %t59 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 4
  store i32 0, i32* %t59, align 4
  %t60 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 5
  store i32 1, i32* %t60, align 4
  %t61 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 6
  store i32 1, i32* %t61, align 4
  %t62 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 7
  store i32 5, i32* %t62, align 4
  %t63 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 8
  store i32 7, i32* %t63, align 4
  %t64 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 9
  store i32 8, i32* %t64, align 4
  store i32 10, i32* %t114, align 4
  %t67 = getelementptr inbounds [10 x i32], [10 x i32]* %t115, i32 0, i32 0
  %t68 = load i32, i32* %t114, align 4
  %t69 = call i32 @maxArea(i32* %t67, i32 %t68)
  store i32 %t69, i32* %t114, align 4
  %t70 = load i32, i32* %t114, align 4
  ret i32 %t70
}
