...
B370:                               	; preds = %B365
  br label %B367
B367:                               	; preds = %B370
  store i32 10, i32* %t364, align 4
  store i32 0, i32* %t357, align 4
  %t193 = load i32, i32* %t364, align 4
  call void @putch(i32 %t193)
  br label %B372
B372:                               	; preds = %B367, %B373
  %t194 = load i32, i32* %t357, align 4
  %t195 = load i32, i32* @N, align 4
  %t196 = icmp slt i32 %t194, %t195
  br i1 %t196, label %B373, label %B377
B373:                               	; preds = %B372
  %t198 = load i32, i32* %t357, align 4
  %t199 = getelementptr inbounds [3 x i32], [3 x i32]* %t355, i32 0, i32 %t198
  %t378 = load i32, i32* %t199, align 4
  store i32 %t378, i32* %t364, align 4
  %t200 = load i32, i32* %t364, align 4
...
B381:                               	; preds = %B384
  store i32 10, i32* %t364, align 4
  %t218 = load i32, i32* %t364, align 4
