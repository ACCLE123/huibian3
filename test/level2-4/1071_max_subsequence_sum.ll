...
B96:
  ...
  %t40 = sub i32 0, 4
  %t39 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 0
  store i32 %t40, i32* %t39, align 4
  %t41 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 1
  store i32 3, i32* %t41, align 4
  %t42 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 2
  store i32 9, i32* %t42, align 4
  %t44 = sub i32 0, 2
  %t43 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 3
  ...
  %t49 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 7
  store i32 5, i32* %t49, align 4
  %t50 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 8
  store i32 7, i32* %t50, align 4
  %t51 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 9
  store i32 8, i32* %t51, align 4
  store i32 10, i32* %t97, align 4
  %t54 = getelementptr inbounds [10 x i32], [10 x i32]* %t98, i32 0, i32 0
  %t55 = load i32, i32* %t97, align 4
  %t56 = call i32 @maxSubArray(i32* %t54, i32 %t55)
  store i32 %t56, i32* %t97, align 4
  %t57 = load i32, i32* %t97, align 4
  ret i32 %t57
}
