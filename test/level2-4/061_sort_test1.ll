...
B103:
  ...
  %t44 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 0
  store i32 4, i32* %t44, align 4
  %t45 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 1
  store i32 3, i32* %t45, align 4
  %t46 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 2
  store i32 9, i32* %t46, align 4
  %t47 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 3
  store i32 2, i32* %t47, align 4
  %t48 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 4
  store i32 0, i32* %t48, align 4
  %t49 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 5
  store i32 1, i32* %t49, align 4
  %t50 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 6
  store i32 6, i32* %t50, align 4
  %t51 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 7
  store i32 5, i32* %t51, align 4
  %t52 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 8
  store i32 7, i32* %t52, align 4
  %t53 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 9
  store i32 8, i32* %t53, align 4
  %t56 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 0
  %t57 = call i32 @bubblesort(i32* %t56)
  store i32 %t57, i32* %t105, align 4
  br label %B106
B106:                               	; preds = %B103, %B107
  %t58 = load i32, i32* %t105, align 4
  %t59 = load i32, i32* @n, align 4
  %t60 = icmp slt i32 %t58, %t59
  br i1 %t60, label %B107, label %B111
B107:                               	; preds = %B106
  %t63 = load i32, i32* %t105, align 4
  %t64 = getelementptr inbounds [10 x i32], [10 x i32]* %t104, i32 0, i32 %t63
  %t113 = load i32, i32* %t64, align 4
  store i32 %t113, i32* %t112, align 4
  %t65 = load i32, i32* %t112, align 4
  call void @putint(i32 %t65)
  store i32 10, i32* %t112, align 4
  %t67 = load i32, i32* %t112, align 4
  call void @putch(i32 %t67)
  %t69 = load i32, i32* %t105, align 4
  %t70 = add i32 %t69, 1
  store i32 %t70, i32* %t105, align 4
  br label %B106
B111:                               	; preds = %B106
  br label %B108
B108:                               	; preds = %B111
